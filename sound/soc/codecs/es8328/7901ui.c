...
//	schedule_delayed_work(&codec->delayed_work, msecs_to_jiffies(1000));
	...
	es8328_write(codec, ES8328_ADCCONTROL2,  0x50);		// 0x0a
	...
	es8328_write(codec, ES8328_ADCCONTROL10,  0xda);	// 0x12
	es8328_write(codec, ES8328_ADCCONTROL11, 0xc0);		// 0x13
	es8328_write(codec, ES8328_ADCCONTROL12, 0x14);		// 0x14
	es8328_write(codec, ES8328_ADCCONTROL13, 0x06);		// 0x15
	es8328_write(codec, ES8328_ADCCONTROL14, 0xeb);		// 0x16
	es8328_write(codec, ES8328_DACCONTROL1, 0x18);		// 0x17
	es8328_write(codec, ES8328_DACCONTROL2, 0x02);		// 0x18

	es8328_write(codec, ES8328_DACCONTROL4, 0x0);		// 0x1a
	es8328_write(codec, ES8328_DACCONTROL5, 0x0);		// 0x1b
	...
	es8328_write(codec, ES8328_DACCONTROL24, 0x13);		// 0x2e
	es8328_write(codec, ES8328_DACCONTROL25, 0x13);		// 0x2f
