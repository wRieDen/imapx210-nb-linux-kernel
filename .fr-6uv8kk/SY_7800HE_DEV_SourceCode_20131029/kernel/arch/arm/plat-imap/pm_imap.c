...
#if (CONFIG_IMAP_LOWLEVEL_UART_PORT == 0)
	/****************UART0**************************/
...
#elif	(CONFIG_IMAP_LOWLEVEL_UART_PORT == 1)
	/****************UART1**************************/
	__raw_writel(((__raw_readl(rGPACON) &(~(0xf<<8))) | (0xa<<8)), rGPACON);
	rUARTRBR_CLKSEL = __raw_readl(rUART1_CLKSEL);
	rUARTRBR_CLKSEL &= ~((0x3 << UARTRBR_CLKSEL_COM));
	rUARTRBR_CLKSEL |= ((rUARTRBR_CLKSEL_PCLK << UARTRBR_CLKSEL_COM));
    	__raw_writel(rUARTRBR_CLKSEL, rUART1_CLKSEL);
...
//	__raw_writel(rUARTRBR1_IIR_FCR, rUART0_IIR_FCR);
	...
	//config baundrate
	rUARTRBR1_LCR = __raw_readl(rUART1_LCR);
	rUARTRBR1_LCR |= (1 << UARTRBR_LCR_DLAB);
	__raw_writel(rUARTRBR1_LCR, rUART1_LCR);	//DLAB=1
    	
	rUARTRBR1_THR_DLL_IMAP = v0 & 0x000000FF;
	__raw_writel(rUARTRBR1_THR_DLL_IMAP, rUARTRBR1_THR_DLL);
	rUARTRBR1_IER_DLH = (v0 & 0x0000FF00) >> 8;
	__raw_writel(rUARTRBR1_IER_DLH, rUART1_IER_DLH);
		
	rUARTRBR1_LCR &= ~(1 << UARTRBR_LCR_DLAB);
	__raw_writel(rUARTRBR1_LCR, rUART1_LCR);	//DLAB=0
	...
	//PARITY-Bit
	rUARTRBR1_LCR &= ~(1 << UARTRBR_LCR_EPS);
	__raw_writel(rUARTRBR1_LCR, rUART1_LCR);

#elif	(CONFIG_IMAP_LOWLEVEL_UART_PORT == 2)
	/****************UART2**************************/
	__raw_writel(((__raw_readl(rGPBCON) &(~0xf)) | 0xa), rGPBCON);
	rUARTRBR_CLKSEL = __raw_readl(rUART2_CLKSEL);
	rUARTRBR_CLKSEL &= ~((0x3 << UARTRBR_CLKSEL_COM));
	rUARTRBR_CLKSEL |= ((rUARTRBR_CLKSEL_PCLK << UARTRBR_CLKSEL_COM));
    	__raw_writel(rUARTRBR_CLKSEL, rUART2_CLKSEL);
...
//	__raw_writel(rUARTRBR1_IIR_FCR, rUART0_IIR_FCR);
	...
	//config baundrate
	rUARTRBR1_LCR = __raw_readl(rUART2_LCR);
	rUARTRBR1_LCR |= (1 << UARTRBR_LCR_DLAB);
	__raw_writel(rUARTRBR1_LCR, rUART2_LCR);	//DLAB=1
    	
	rUARTRBR1_THR_DLL_IMAP = v0 & 0x000000FF;
	__raw_writel(rUARTRBR1_THR_DLL_IMAP, rUARTRBR2_THR_DLL);
	rUARTRBR1_IER_DLH = (v0 & 0x0000FF00) >> 8;
	__raw_writel(rUARTRBR1_IER_DLH, rUART2_IER_DLH);
		
	rUARTRBR1_LCR &= ~(1 << UARTRBR_LCR_DLAB);
	__raw_writel(rUARTRBR1_LCR, rUART2_LCR);	//DLAB=0
	...
	//PARITY-Bit
	rUARTRBR1_LCR &= ~(1 << UARTRBR_LCR_EPS);
	__raw_writel(rUARTRBR1_LCR, rUART2_LCR);

#elif	(CONFIG_IMAP_LOWLEVEL_UART_PORT == 3)
	/****************UART3**************************/
	__raw_writel(((__raw_readl(rGPBCON) &(~(0xf<<4))) | (0xa<<4)), rGPBCON);
	rUARTRBR_CLKSEL = __raw_readl(rUART3_CLKSEL);
	rUARTRBR_CLKSEL &= ~((0x3 << UARTRBR_CLKSEL_COM));
	rUARTRBR_CLKSEL |= ((rUARTRBR_CLKSEL_PCLK << UARTRBR_CLKSEL_COM));
    	__raw_writel(rUARTRBR_CLKSEL, rUART3_CLKSEL);
...
//	__raw_writel(rUARTRBR1_IIR_FCR, rUART0_IIR_FCR);
	...
	//config baundrate
	rUARTRBR1_LCR = __raw_readl(rUART3_LCR);
	rUARTRBR1_LCR |= (1 << UARTRBR_LCR_DLAB);
	__raw_writel(rUARTRBR1_LCR, rUART3_LCR);	//DLAB=1
    	
	rUARTRBR1_THR_DLL_IMAP = v0 & 0x000000FF;
	__raw_writel(rUARTRBR1_THR_DLL_IMAP, rUARTRBR3_THR_DLL);
	rUARTRBR1_IER_DLH = (v0 & 0x0000FF00) >> 8;
	__raw_writel(rUARTRBR1_IER_DLH, rUART3_IER_DLH);
		
	rUARTRBR1_LCR &= ~(1 << UARTRBR_LCR_DLAB);
	__raw_writel(rUARTRBR1_LCR, rUART3_LCR);	//DLAB=0
	...
	//PARITY-Bit
	rUARTRBR1_LCR &= ~(1 << UARTRBR_LCR_EPS);
	__raw_writel(rUARTRBR1_LCR, rUART3_LCR);
#endif
