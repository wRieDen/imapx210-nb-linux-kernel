...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_E1750) },//huawei e1750
...
//   { USB_DEVICE_AND_INTERFACE_INFO(ZTE_VENDOR_ID, 0x0053, 0xff, 0xff, 0xff) },
    ...
    /******************************************************************************
     * Begin add for 3G Modem, Xu lei, 2011-11-01
     ******************************************************************************/
    { USB_DEVICE(0x028a, 0x1006) }, /* SHICHUANG W50 */
    { USB_DEVICE(0x028a, 0x1009) }, /* SR Wireless 1XEVDO Modem */
    { USB_DEVICE_AND_INTERFACE_INFO(0x05c6, 0x0015, 0xff, 0xff, 0xff) },
    { USB_DEVICE_AND_INTERFACE_INFO(0x05c6, 0x0018, 0xff, 0xff, 0xff) },
    { USB_DEVICE(0x05c6, 0x00a0) }, /* ASB C820 */
    { USB_DEVICE_AND_INTERFACE_INFO(0x05c6, 0x1000, 0xff, 0xff, 0xff) },
	{ USB_DEVICE(0x05c6, 0x3197) },
    { USB_DEVICE(0x05c6, 0x6280) }, /* JINGYU W80 */
    { USB_DEVICE(0x05c6, 0x9000) }, /* Tenda W6 */
	{ USB_DEVICE(0x05c6, 0x9025) },
    { USB_DEVICE(0x0685, 0x7000) }, /* LianChen 6280 */
    { USB_DEVICE(0x1234, 0x0036)},
    { USB_DEVICE_AND_INTERFACE_INFO(0x12d1, 0x1c05, 0xff, 0xff, 0xff) },
    { USB_DEVICE(0x1410, 0x7042) },
    { USB_DEVICE(0x15eb, 0x0001) },
    { USB_DEVICE(0x15eb, 0x7152) }, /* Tenda 3G189C EVDO */
    { USB_DEVICE_AND_INTERFACE_INFO(0x17ef, 0x7002, 0xff, 0xff, 0xff) }, /* Lenovo CE200 EVDO */
    { USB_DEVICE_AND_INTERFACE_INFO(0x17ef, 0x7003, 0xff, 0xff, 0xff) }, /* Lenovo TD201 */
    { USB_DEVICE_AND_INTERFACE_INFO(0x17ef, 0x7004, 0xff, 0xff, 0xff) }, /* Lenovo TD201 */
	{ USB_DEVICE(0x1782, 0x3d02) }, /* 3G telephone */
    { USB_DEVICE(0x19d2, 0x0170) }, //ZTE-T A371B
    { USB_DEVICE(0x19d2, 0xfffe) },//ZTE AC2791
    { USB_DEVICE(0x19f5, 0x9004) }, /* LOGO Mobile */
    { USB_DEVICE(0x19f5, 0x9013) }, /* LOGO Mobile */
    { USB_DEVICE(0x19f5, 0x9909) }, /* Telcom EVDO */
    { USB_DEVICE(0x19f5, 0x9905) }, /* Telcom EVDO */
    { USB_DEVICE(0x1ab7, 0x2200) }, /*SHANGHAI DA 8026-G+ */
    { USB_DEVICE_AND_INTERFACE_INFO(0x1c9e, 0x6000, 0xff, 0xff, 0xff) }, /* Crius 154*/
    { USB_DEVICE_AND_INTERFACE_INFO(0x1c9e, 0x6061, 0xff, 0xff, 0xff) },
    { USB_DEVICE(0x1c9e, 0x9605) },
    { USB_DEVICE(0x1d09, 0x4299) },
    { USB_DEVICE(0x1d09, 0xaef4) }, /* JINGYU C819 */
    { USB_DEVICE(0x1e89, 0x1a16) }, /* Vtion U1916 WCDMA*/
    { USB_DEVICE(0x1e89, 0x1e16) }, /* Vtion E1916 */
    { USB_DEVICE(0x201e, 0x1022) },//smartfren
    { USB_DEVICE(0x2020, 0x1005) },
    { USB_DEVICE(0x2077, 0x9002) }, /* Inner model*/
    { USB_DEVICE(0x2077, 0xa000) }, /* WU168*/
    { USB_DEVICE(0x20a6, 0x1008) },
    { USB_DEVICE(0x20a6, 0x1105) },
    { USB_DEVICE(0x2140, 0x8bf5) }, /* VIA TeleCom CBP7.0 */
    { USB_DEVICE(0x21f5, 0x2008) },
    { USB_DEVICE_AND_INTERFACE_INFO(0x2604, 0x3006, 0xff, 0xff, 0xff) }, /* tenda 3G-W6 */
    /******************************************************************************
     * End add
     ******************************************************************************/
...
#define USBDONGLE_PATH          "/system/bin/usbdongle"
static void option_early_suspend(struct early_suspend *h)
{
	static char * usbdongle_path = USBDONGLE_PATH;
	char *argv[] = { usbdongle_path, "-p", NULL };
	static char *envp[] = { NULL };
    int ret;

	printk("%s entered \n", __func__);
	ret = call_usermodehelper(usbdongle_path,
				   argv, envp, UMH_NO_WAIT);
	printk("call_usermodehelper:  %s %s return %d \n", argv[0], argv[1], ret);
}

static void option_early_resume(struct early_suspend *h)
{
    static char * usbdongle_path = USBDONGLE_PATH;
    char *argv[] = { usbdongle_path, "-u", NULL };
    static char *envp[] = { NULL };
    int ret;
...
static struct early_suspend option_early_suspend_desc = {
	.level = EARLY_SUSPEND_LEVEL_BLANK_SCREEN,
	//.suspend = option_early_suspend,
	//.resume = option_early_resume,
};
...
static int __init option_init(void)
{
	...
	register_early_suspend(&option_early_suspend_desc);
...
{
	unregister_early_suspend(&option_early_suspend_desc);
