...
/******************************************************************************
 * Begin add for 3G Modem, Xu lei, 2011-09-13
 ******************************************************************************/
...
UNUSUAL_DEV(  0x12d1, 0x1003, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e220_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x101e, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei2_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x140c, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1414, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e220_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1446, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x14ad, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x14c1, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),
...
UNUSUAL_DEV(  0x12d1, 0x1520, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1521, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1523, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1557, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei1_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1c0b, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei3_init,
        0),

UNUSUAL_DEV(  0x12d1, 0x1da1, 0x0000, 0x9999,
        "HUAWEI MOBILE",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_huawei_e220_init,
        0),
...
UNUSUAL_DEV(  0x05c6, 0x0018, 0x0000, 0x9999,
        "Option N.V.",
        "Mass Storage",
        US_SC_DEVICE, US_PR_DEVICE, usb_stor_eject_cd,
        0),
 ...
 * Tenda W6
 */
UNUSUAL_DEV(  0x05c6, 0xf000, 0x0000, 0x9999,
		"Tenda",
		"Tenda CDMA Technologies MSM",
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_tenda_w6,
		0),
...
UNUSUAL_DEV(  0x19d2, 0x2000, 0x0000, 0x9999,
       ...
       "ZTE MF627/MF628/MF628+ HSDPA",
       US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_mu318_init,
       0),

UNUSUAL_DEV(  0x19d2, 0x0033, 0x0000, 0x9999,
       "ZTE, Incorporated",
...
/*
 * WEI-WEN. (Tenda 3G189C)
 */
UNUSUAL_DEV(  0x15eb, 0x7153, 0x0000, 0x9999,
           "China TeleCom",
           "CBP7.0",
           US_SC_DEVICE, US_PR_DEVICE, usb_stor_eject_cd,
           0),

UNUSUAL_DEV(  0x1a8a, 0x1009, 0x0000, 0x9999,
		"Option N.V.",
		"Mass Storage",
	     US_SC_DEVICE, US_PR_DEVICE, usb_stor_eject_cd,
		 0),

UNUSUAL_DEV(  0x1c9e, 0x6061, 0x0000, 0x9999,
           "Qualcomm, Incorporated",
           "Qualcomm CDMA Technologies MSM",
           US_SC_DEVICE, US_PR_DEVICE, option_ms_init,
           0),

UNUSUAL_DEV(  0x1e89, 0x1e16, 0x0000, 0x9999,
           "Qualcomm, Incorporated",
           "USB MMC Storage",
           US_SC_DEVICE, US_PR_DEVICE, usb_stor_port_reset,
           0),

UNUSUAL_DEV(  0x8880, 0x6500, 0x0000, 0x9999,
           "Qualcomm, Incorporated",
           "Qualcomm CDMA Technologies MSM",
           US_SC_DEVICE, US_PR_DEVICE, usb_stor_eject_cd,
           0),
           
UNUSUAL_DEV(  0x2077, 0xf000, 0x0000, 0x9999,
           "Qualcomm, Incorporated",
           "Qualcomm CDMA Technologies MSM",
           US_SC_DEVICE, US_PR_DEVICE, usb_stor_eject_cd,
           0),      
...
UNUSUAL_DEV ( 0x19d2, 0xfff5, 0x0000, 0x0000,
		...
		US_SC_DEVICE, US_PR_DEVICE, usb_stor_zte_scsi_init,
		0),
