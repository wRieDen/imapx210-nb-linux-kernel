...
#define SOOPS_IOCMD_GET_SPAN2KEY_STATUS  _IOR(SOOPS_IOCMD_MAGIC, 9, int)
#define SOOPS_IOCMD_CLEAR_SPAN2KEY_STATUS _IO(SOOPS_IOCMD_MAGIC, 10)
#endif
