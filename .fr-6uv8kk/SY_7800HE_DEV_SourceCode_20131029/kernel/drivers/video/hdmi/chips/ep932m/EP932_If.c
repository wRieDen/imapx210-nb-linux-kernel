...
unsigned char HDMI_Tx_HTPLG(void)
{
	...
	{
		printk(KERN_ALERT "[HDMI] return 1 :connect");
//		DBG_printf(("[HDMI]HDMI_Tx_HTPLG connect\r\n"));
		return 1;
	}
	else
	{
		printk(KERN_ALERT "[HDMI] return 0 :desconnect");
//		DBG_printf(("[HDMI]HDMI_Tx_HTPLG disconnect\r\n"));
		return 0;
	}
