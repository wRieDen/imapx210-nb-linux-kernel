...
#define TS_POLL_PERIOD			100 /* ms delay between samples */
...
static int volumeup=0;
static int volumedown=0;
struct ts_event {
	u16	x;
	u16	y;
	u16	z1, z2;
...
{
	u32 rt = 0;
	//printk("====tsc2007_calculate_pressure====\n");
	/* range filtering */
	if (tc->x == MAX_12BIT)
		tc->x = 0;
