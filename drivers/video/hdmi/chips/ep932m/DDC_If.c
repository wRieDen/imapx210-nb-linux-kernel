...
{
	int i;
	unsigned char seg_ptr, BlockCount, Block1Found; 
	...
	//----------------------------------------------------------------------------
	DDC_Data[0] = 0;							// Segment Pointer
	// DDC send 'START'							// IIC START
	// DDC send '0x60'							// Segment Pointer Address = 0x60
	// DDC send 'Segment Pointer' (DDC_Data[0]) // Segment Pointer = 0
	//----------------------------------------------------------------------------
...
*/
	...
	for (seg_ptr = 1; seg_ptr <= BlockCount; ++seg_ptr) {
		...
		//----------------------------------------------------------------------------
		// Segment Pointer
		DDC_Data[0] = seg_ptr >> 1;	// Segment Pointer 
		// DDC send 'START'							// IIC START
		// DDC send '0x60'							// Segment Pointer Address = 0x60
		// DDC send 'Segment Pointer' (DDC_Data[0]) // Segment Pointer = seg_ptr >> 1
		//----------------------------------------------------------------------------
