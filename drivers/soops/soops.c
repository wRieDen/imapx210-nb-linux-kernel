...
extern int span2_key_locking;
static int hidinput_get_span_key_locking_status(void)
{
	return span_key_locking;
}
 static int hidinput_get_span2_key_locking_status(void)
{
	return span2_key_locking;
}
extern void usbinput_clear_span2_key_locking_status(void);
...
#endif
			break;
		case SOOPS_IOCMD_GET_SPAN2KEY_STATUS:
			__put_user(hidinput_get_span2_key_locking_status(), (int *)arg);
			break;

		case SOOPS_IOCMD_CLEAR_SPAN2KEY_STATUS:
			usbinput_clear_span2_key_locking_status();
#if defined(CONFIG_KEYBOARD_MATRIX)
			keyinput_clear_span2_key_locking_status();
#endif
			break;
#endif
